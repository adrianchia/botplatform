...
Module Module1
    ...
    Function GetCommandList() As String
        GetCommandList = _
            ...
            " ddp ------- set delux display picture." + vbCr + _
    ...
    Sub MessageReceived(ByVal session As IRobotSession, ByVal message As IRobotMessage)
        Try
            ...
            ElseIf cmd = "ddp" Then
                m_server.SetDisplayPictureEx(Nothing, "dp.png", "ddp.dat")
    ...
    <MTAThread> Sub Main()
        Try
            Dim robotServerFactory As IRobotServerFactory = New RobotServerFactory
            robotServerFactory.Init(10)

            m_server = robotServerFactory.CreateRobotServer("bottest.com", 6602)
            m_server.Login("SP000125", "test111", 0)

...
public interface RobotServer {
     ...
     * Set all robots' display picture
     * @param displayPicture unique name of the dp resource pre-uploaded to BOTPLATFORM and verified by BOTPLATFORM
     * @param deluxePicture unique name of the ddp resource pre-uploaded to BOTPLATFORM and verified by BOTPLATFORM
     */
     ...
     * @param deluxePicture unique name of the ddp resource pre-uploaded to BOTPLATFORM and verified by BOTPLATFORM
     */    
    public void setDisplayPictureEx(String robotAccount, String displayPicture, String deluxePicture) throws RobotException;

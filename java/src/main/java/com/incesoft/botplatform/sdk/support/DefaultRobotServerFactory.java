...
public class DefaultRobotServerFactory extends RobotServerFactory {
    ...
    public DefaultRobotServerFactory() {
        ...
        if (bufferAllocator instanceof PooledByteBufferAllocator) {
        	((PooledByteBufferAllocator)bufferAllocator).setTimeout(timeout);//seconds
        }
        ...
        //filterChainBuilder.addLast("threadpool-filter", new ExecutorFilter(this.threadPoolExecutor)) ;

...
public:
	...
	HRESULT Fire_UserAdd( BSTR robot,  BSTR user)
	{
		HRESULT hr = S_OK;
		T * pThis = static_cast<T *>(this);
		int cConnections = m_vec.GetSize();
	...
	HRESULT Fire_UserRemove( BSTR robot,  BSTR user)
	{
		HRESULT hr = S_OK;
		T * pThis = static_cast<T *>(this);
		int cConnections = m_vec.GetSize();
	...
	HRESULT Fire_UserUpdated( BSTR robot,  IRobotUser * user)
	{
		HRESULT hr = S_OK;
		T * pThis = static_cast<T *>(this);
		int cConnections = m_vec.GetSize();
	...
	HRESULT Fire_PersonalMessageUpdated( BSTR robot,  BSTR user,  BSTR personalMessage)
	{
		HRESULT hr = S_OK;
		T * pThis = static_cast<T *>(this);
		int cConnections = m_vec.GetSize();
	...
	HRESULT Fire_ContactListReceived( BSTR robot,  IRobotUsers * contactList)
	{
		HRESULT hr = S_OK;
		T * pThis = static_cast<T *>(this);
		int cConnections = m_vec.GetSize();
	...
	HRESULT Fire_SceneUpdated( BSTR robot,  BSTR user,  IRobotResource * resource)
	{
		HRESULT hr = S_OK;
		T * pThis = static_cast<T *>(this);
		int cConnections = m_vec.GetSize();
	...
	HRESULT Fire_DisplayPictureUpdated( BSTR robot,  BSTR user,  IRobotResource * resource)
	{
		HRESULT hr = S_OK;
		T * pThis = static_cast<T *>(this);
		int cConnections = m_vec.GetSize();
	...
	HRESULT Fire_ColorSchemeUpdated( BSTR robot,  BSTR user,  LONG colorScheme)
	{
		HRESULT hr = S_OK;
		T * pThis = static_cast<T *>(this);
		int cConnections = m_vec.GetSize();
